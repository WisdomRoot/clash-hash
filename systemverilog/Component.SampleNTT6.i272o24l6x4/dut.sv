...
,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}};
  ...
  logic [1599:0] c$state4_app_arg;
  logic [1599:0] c$state4_app_arg_0;
  logic [1599:0] c$state4_app_arg_1;
  dut_types::Tuple2_5 c$arg;
  dut_types::array_of_8_Tuple2_6 c$vec1;
  dut_types::array_of_8_logic_vector_100 c$vec2;
  logic [4:0] state4_fun_arg;
  logic [4:0] c$state4_app_arg_fun_arg;
  logic [4:0] c$state4_app_arg_fun_arg_0;
  ...
  Component_SampleNTT6_i272o24l6x4_keccakF1600 Component_SampleNTT6_i272o24l6x4_keccakF1600_c$keccakF1600_out
  ...
  assign state4_fun_arg = counter + 5'd3;

  Component_SampleNTT6_i272o24l6x4_keccakF1600 Component_SampleNTT6_i272o24l6x4_keccakF1600_state4
    ( .result (state4)
    , .roundIdx (state4_fun_arg)
    , .x (c$state4_app_arg) );

  assign result_12 = (counter == 5'd20) ? {{{2'b10,4'd0,1'bx}
                                           ,state4
                                           ,buffer}
                                          ,{1'b0
                                           ,{24'b000000000000000000000000
                                            ,1'b0
                                            ,1'b0}}} : {{{2'b01,counter + 5'd4}
                                                        ,state4
                                                        ,buffer}
                                                       ,{1'b0
                                                        ,{24'b000000000000000000000000,1'b0,1'b0}}};

  assign c$state4_app_arg_fun_arg = counter + 5'd2;

  Component_SampleNTT6_i272o24l6x4_keccakF1600 Component_SampleNTT6_i272o24l6x4_keccakF1600_c$state4_app_arg
    ( .result (c$state4_app_arg)
    , .roundIdx (c$state4_app_arg_fun_arg)
    , .x (c$state4_app_arg_0) );

  assign c$state4_app_arg_fun_arg_0 = counter + 5'd1;

  Component_SampleNTT6_i272o24l6x4_keccakF1600 Component_SampleNTT6_i272o24l6x4_keccakF1600_c$state4_app_arg_0
    ( .result (c$state4_app_arg_0)
    , .roundIdx (c$state4_app_arg_fun_arg_0)
    , .x (c$state4_app_arg_1) );

  Component_SampleNTT6_i272o24l6x4_keccakF1600 Component_SampleNTT6_i272o24l6x4_keccakF1600_c$state4_app_arg_1
    ( .result (c$state4_app_arg_1)
    , .roundIdx (counter)
    , .x (state) );
