...
,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}};
  ...
  dut_types::Tuple2_3 c$case_alt_18;
  logic [11:0] c7;
  logic [11:0] c6;
  logic [11:0] c5;
  logic [11:0] c4;
  ...
  logic [1599:0] state8;
  dut_types::Tuple2_3 result_12;
  logic [1599:0] c$state8_app_arg;
  logic [1599:0] c$state8_app_arg_0;
  logic [1599:0] c$state8_app_arg_1;
  logic [1599:0] c$state8_app_arg_2;
  logic [1599:0] c$state8_app_arg_3;
  logic [1599:0] c$state8_app_arg_4;
  logic [1599:0] c$state8_app_arg_5;
  dut_types::Tuple2_5 c$arg;
  dut_types::array_of_8_Tuple2_6 c$vec1;
  dut_types::array_of_8_logic_vector_100 c$vec2;
  logic [4:0] state8_fun_arg;
  logic [4:0] c$state8_app_arg_fun_arg;
  logic [4:0] c$state8_app_arg_fun_arg_0;
  logic [4:0] c$state8_app_arg_fun_arg_1;
  logic [4:0] c$state8_app_arg_fun_arg_2;
  logic [4:0] c$state8_app_arg_fun_arg_3;
  logic [4:0] c$state8_app_arg_fun_arg_4;
  ...
  always_comb begin
    case(phase_0[6:5])
      2'b00 : c$case_alt_0 = c$case_alt_1;
      2'b01 : c$case_alt_0 = result_3;
      default : c$case_alt_0 = result_1;
    endcase
  end

  assign c$case_alt_1 = msgValid ? {{{2'b01,5'd0}
                                    ,result_9
                                    ,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}}
                                   ,{1'b0
  ...
  always_comb begin
    case(buffer_0[111:108])
      4'b0000 : result_1 = c$case_alt_3;
      4'b0001 : result_1 = c$case_alt_2;
  ...
  always_comb begin
    case(result_10[99:96])
      4'b0000 : c$case_alt_3 = {{c$app_arg
                                ,state_0
                                ,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}}
                               ,{1'b0
                                ,{24'b000000000000000000000000,1'b0,1'b0}}};
      4'b0001 : c$case_alt_3 = {{c$app_arg
                                ,state_0
  ...
  assign c$case_alt_18 = tready ? {{c$app_arg
                                   ,state_0
                                   ,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}}
  ...
  assign c$app_arg = (counter_0 == 4'd13) ? {2'b01,5'd0} : {2'b10,counter_0 + 4'd1,1'bx};

  assign result_2 = tready ? {{phase_0
                              ,state_0
                              ,ds4.Tuple2_4_sel1}
                             ,{1'b0
  ...
  assign i = buffer_0[11:0];

  assign h = buffer_0[23:12];

  assign g = buffer_0[35:24];

  assign f = buffer_0[47:36];

  assign e = buffer_0[59:48];

  assign d = buffer_0[71:60];

  assign c = buffer_0[83:72];

  assign b = buffer_0[95:84];

  assign a = buffer_0[107:96];

  assign h_0 = buffer_0[23:12];

  assign g_0 = buffer_0[35:24];

  assign f_0 = buffer_0[47:36];

  assign e_0 = buffer_0[59:48];

  assign d_0 = buffer_0[71:60];

  assign c_0 = buffer_0[83:72];

  assign b_0 = buffer_0[95:84];

  assign a_0 = buffer_0[107:96];

  assign g_1 = buffer_0[35:24];

  assign f_1 = buffer_0[47:36];

  assign e_1 = buffer_0[59:48];

  assign d_1 = buffer_0[71:60];

  assign c_1 = buffer_0[83:72];

  assign b_1 = buffer_0[95:84];

  assign a_1 = buffer_0[107:96];

  assign f_2 = buffer_0[47:36];

  assign e_2 = buffer_0[59:48];

  assign d_2 = buffer_0[71:60];

  assign c_2 = buffer_0[83:72];

  assign b_2 = buffer_0[95:84];

  assign a_2 = buffer_0[107:96];

  assign e_3 = buffer_0[59:48];

  assign d_3 = buffer_0[71:60];

  assign c_3 = buffer_0[83:72];

  assign b_3 = buffer_0[95:84];

  assign a_3 = buffer_0[107:96];

  assign d_4 = buffer_0[71:60];

  assign c_4 = buffer_0[83:72];

  assign b_4 = buffer_0[95:84];

  assign a_4 = buffer_0[107:96];

  assign c_5 = buffer_0[83:72];

  assign b_5 = buffer_0[95:84];

  assign a_5 = buffer_0[107:96];

  assign b_6 = buffer_0[95:84];

  assign a_6 = buffer_0[107:96];

  assign result_3 = (counter_1 == 5'd23) ? {{{2'b10,4'd0,1'bx}
                                            ,c$keccakF1600_out
                                            ,buffer_0}
                                           ,{1'b0
                                            ,{24'b000000000000000000000000
  ...
  assign buffer_0 = c$ds_app_arg.State_sel2;
  ...
  assign c$chunk_app_arg = state_0;

  assign counter_0 = phase_0[4:1];

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$keccakF1600_out
    ( .result (c$keccakF1600_out)
    , .roundIdx (counter_1)
    , .x (state_0) );

  assign counter_1 = phase_0[4:0];

  assign phase_0 = c$ds_app_arg.State_sel0;

  assign state_0 = c$ds_app_arg.State_sel1;

  assign state8_fun_arg = counter + 5'd7;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_state8
    ( .result (state8)
    , .roundIdx (state8_fun_arg)
    , .x (c$state8_app_arg) );

  assign result_12 = (counter == 5'd16) ? {{{2'b10,4'd0,1'bx}
                                           ,state8
                                           ,buffer}
                                          ,{1'b0
                                           ,{24'b000000000000000000000000
                                            ,1'b0
                                            ,1'b0}}} : {{{2'b01,counter + 5'd8}
                                                        ,state8
                                                        ,buffer}
                                                       ,{1'b0
                                                        ,{24'b000000000000000000000000,1'b0,1'b0}}};

  assign c$state8_app_arg_fun_arg = counter + 5'd6;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg
    ( .result (c$state8_app_arg)
    , .roundIdx (c$state8_app_arg_fun_arg)
    , .x (c$state8_app_arg_0) );

  assign c$state8_app_arg_fun_arg_0 = counter + 5'd5;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_0
    ( .result (c$state8_app_arg_0)
    , .roundIdx (c$state8_app_arg_fun_arg_0)
    , .x (c$state8_app_arg_1) );

  assign c$state8_app_arg_fun_arg_1 = counter + 5'd4;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_1
    ( .result (c$state8_app_arg_1)
    , .roundIdx (c$state8_app_arg_fun_arg_1)
    , .x (c$state8_app_arg_2) );

  assign c$state8_app_arg_fun_arg_2 = counter + 5'd3;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_2
    ( .result (c$state8_app_arg_2)
    , .roundIdx (c$state8_app_arg_fun_arg_2)
    , .x (c$state8_app_arg_3) );

  assign c$state8_app_arg_fun_arg_3 = counter + 5'd2;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_3
    ( .result (c$state8_app_arg_3)
    , .roundIdx (c$state8_app_arg_fun_arg_3)
    , .x (c$state8_app_arg_4) );

  assign c$state8_app_arg_fun_arg_4 = counter + 5'd1;

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_4
    ( .result (c$state8_app_arg_4)
    , .roundIdx (c$state8_app_arg_fun_arg_4)
    , .x (c$state8_app_arg_5) );

  Component_SampleNTT6_i272o24l6x8_keccakF1600 Component_SampleNTT6_i272o24l6x8_keccakF1600_c$state8_app_arg_5
    ( .result (c$state8_app_arg_5)
    , .roundIdx (counter)
    , .x (state) );
