package Component_SampleNTT2_types;
  ...
  typedef struct packed {
    logic [1620:0] Tuple2_sel0;
    Tuple2_1 Tuple2_sel1;
  } Tuple2;
  typedef logic [0:0] array_of_12_logic_vector_1 [0:11];
  typedef logic  array_of_12_logic [0:11];
  ...
  function automatic logic [0:11][0:0] array_of_12_logic_vector_1_to_lv(array_of_12_logic_vector_1 i);
    for (int n = 0; n < 12; n=n+1)
      array_of_12_logic_vector_1_to_lv[n] = i[n];
  endfunction
  function automatic array_of_12_logic_vector_1 array_of_12_logic_vector_1_from_lv(logic [0:11][0:0] i);
    for (int n = 0; n < 12; n=n+1)
      array_of_12_logic_vector_1_from_lv[n] = i[n];
  endfunction
  function automatic array_of_12_logic_vector_1 array_of_12_logic_vector_1_cons(logic [0:0] x,logic [0:0] xs [0:10]);
    array_of_12_logic_vector_1_cons[0] = x;
    array_of_12_logic_vector_1_cons[1:11] = xs;
  endfunction
  function automatic logic [0:11][0:0] array_of_12_logic_to_lv(array_of_12_logic i);
    for (int n = 0; n < 12; n=n+1)
      array_of_12_logic_to_lv[n] = i[n];
  endfunction
  function automatic array_of_12_logic array_of_12_logic_from_lv(logic [0:11][0:0] i);
    for (int n = 0; n < 12; n=n+1)
      array_of_12_logic_from_lv[n] = i[n];
  endfunction
  function automatic array_of_12_logic array_of_12_logic_cons(logic x,logic  xs [0:10]);
    array_of_12_logic_cons[0] = x;
    array_of_12_logic_cons[1:11] = xs;
  endfunction
...
endpackage : Component_SampleNTT2_types
