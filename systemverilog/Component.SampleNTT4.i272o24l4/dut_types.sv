package dut_types;
  ...
  typedef struct packed {
    ...
    logic [86:0] State_sel2;
  } State;
  typedef struct packed {
    logic [23:0] Tuple2_4_sel0;
    logic [86:0] Tuple2_4_sel1;
  } Tuple2_4;
  typedef struct packed {
    logic [11:0] Tuple2_6_sel0;
    logic Tuple2_6_sel1;
  } Tuple2_6;
  typedef Tuple2_6  array_of_6_Tuple2_6 [0:5];
  typedef struct packed {
  ...
  typedef logic [74:0] array_of_7_logic_vector_75 [0:6];
  typedef logic [74:0] array_of_6_logic_vector_75 [0:5];
  typedef struct packed {
    State Tuple2_3_sel0;
  ...
  function automatic logic [0:5][12:0] array_of_6_Tuple2_6_to_lv(array_of_6_Tuple2_6 i);
    for (int n = 0; n < 6; n=n+1)
      array_of_6_Tuple2_6_to_lv[n] = i[n];
  endfunction
  function automatic array_of_6_Tuple2_6 array_of_6_Tuple2_6_from_lv(logic [0:5][12:0] i);
    for (int n = 0; n < 6; n=n+1)
      array_of_6_Tuple2_6_from_lv[n] = i[n];
  endfunction
  function automatic array_of_6_Tuple2_6 array_of_6_Tuple2_6_cons(Tuple2_6 x,Tuple2_6  xs [0:4]);
    array_of_6_Tuple2_6_cons[0] = x;
    array_of_6_Tuple2_6_cons[1:5] = xs;
  endfunction
  ...
  function automatic logic [0:6][74:0] array_of_7_logic_vector_75_to_lv(array_of_7_logic_vector_75 i);
    for (int n = 0; n < 7; n=n+1)
      array_of_7_logic_vector_75_to_lv[n] = i[n];
  endfunction
  function automatic array_of_7_logic_vector_75 array_of_7_logic_vector_75_from_lv(logic [0:6][74:0] i);
    for (int n = 0; n < 7; n=n+1)
      array_of_7_logic_vector_75_from_lv[n] = i[n];
  endfunction
  function automatic array_of_7_logic_vector_75 array_of_7_logic_vector_75_cons(logic [74:0] x,logic [74:0] xs [0:5]);
    array_of_7_logic_vector_75_cons[0] = x;
    array_of_7_logic_vector_75_cons[1:6] = xs;
  endfunction
  function automatic logic [0:5][74:0] array_of_6_logic_vector_75_to_lv(array_of_6_logic_vector_75 i);
    for (int n = 0; n < 6; n=n+1)
      array_of_6_logic_vector_75_to_lv[n] = i[n];
  endfunction
  function automatic array_of_6_logic_vector_75 array_of_6_logic_vector_75_from_lv(logic [0:5][74:0] i);
    for (int n = 0; n < 6; n=n+1)
      array_of_6_logic_vector_75_from_lv[n] = i[n];
  endfunction
  function automatic array_of_6_logic_vector_75 array_of_6_logic_vector_75_cons(logic [74:0] x,logic [74:0] xs [0:4]);
    array_of_6_logic_vector_75_cons[0] = x;
    array_of_6_logic_vector_75_cons[1:5] = xs;
  endfunction
