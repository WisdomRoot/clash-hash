...
,{4'b0000,108'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}};
  ...
  logic [1599:0] c$keccakF1600_out_1;
  ...
  logic [4:0] c$keccakF1600_out_fun_arg;
  ...
  Component_SampleNTT6_i272o24l6x2_keccakF1600 Component_SampleNTT6_i272o24l6x2_keccakF1600_c$keccakF1600_out
  ...
  Component_SampleNTT6_i272o24l6x2_keccakF1600 Component_SampleNTT6_i272o24l6x2_keccakF1600_c$keccakF1600_out_0
    ( .result (c$keccakF1600_out_0)
    , .roundIdx (counter)
    , .x (state) );

  assign c$keccakF1600_out_fun_arg = counter + 5'd1;

  Component_SampleNTT6_i272o24l6x2_keccakF1600 Component_SampleNTT6_i272o24l6x2_keccakF1600_c$keccakF1600_out_1
    ( .result (c$keccakF1600_out_1)
    , .roundIdx (c$keccakF1600_out_fun_arg)
    , .x (c$keccakF1600_out_0) );

  assign result_12 = (counter == 5'd22) ? {{{2'b10,4'd0,1'bx}
                                           ,c$keccakF1600_out_1
                                           ,buffer}
                                          ,{1'b0
                                           ,{24'b000000000000000000000000
                                            ,1'b0
                                            ,1'b0}}} : {{{2'b01,counter + 5'd2}
                                                        ,c$keccakF1600_out_1
                                                        ,buffer}
                                                       ,{1'b0
                                                        ,{24'b000000000000000000000000,1'b0,1'b0}}};
