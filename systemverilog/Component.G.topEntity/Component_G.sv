...
module Component_G
  ...
  Component_G_types::Tuple2_5 MSG;
  Component_G_types::Tuple3_0 result_fun_arg;
  Component_G_types::Tuple2_4 result;
  Component_G_types::AXI4Stream_0 DIGEST_TDATA_0;
  ...
  Component_G_topEntity_spongeFSM Component_G_topEntity_spongeFSM_result
    ( .result (result)
    , .c$bindCsr (CLK)
    , .c$bindCsr_0 (RST)
    , .c$bindCsr_1 (EN)
