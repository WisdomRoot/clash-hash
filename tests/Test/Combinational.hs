...
-- | Tests for incremental sponge implementation
--
...
-- @SHA3internal.toBitString $(listToVecTH "abc")@ produces BIT-REVERSED bytes:
...
--
-- == Critical Bug Fixed
-- Ref.padded was using @msg ++# zeroPadding@
