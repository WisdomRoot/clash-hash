...
module Test.TestHarness.GGeneral
  ( GGeneralTest,
    gGeneralGen,
    runTest,
    runHardware,
...
type GGeneralTest = ShakeTest

gGeneralGen :: Gen GGeneralTest
gGeneralGen = do
...
runTest :: GGeneralTest -> Expectation
runTest test = do
...
runHardware :: GGeneralTest -> ByteString
runHardware test =
...
testLabel :: GGeneralTest -> P.String
