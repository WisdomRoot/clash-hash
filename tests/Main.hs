...
import Test.Timing.SamplePolyCBD512 qualified
...
main = do
  ...
  samplePolyCBD512TimingTests <- testSpec "Timing.SamplePolyCBD512" Test.Timing.SamplePolyCBD512.spec
