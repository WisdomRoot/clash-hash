...
import qualified Permutation.KeccakF400 as Perm
...
topEntity clk rst en sAxisTValid sAxisTData sAxisTLast mAxisTReady =
  withClockResetEnable clk rst en
    $ Sponge.spongeAxi @System @400 @BusWidth @Rate @DigestBits @20
      (0b01 :: BitVector 2)
  ...
  where
    ...
    permutationComponent ::
      ...
      Reset System ->
      Enable System ->
      Signal System (Index 20, BitVector 400) ->
