...
module Hash.NonPipelined.SampleNTT
  ( topEntity,
  )
where
...
import Sponge.NonPipelined.SampleNTT qualified
...
topEntity clk rst en treadySig inputSig =
  withClockResetEnable clk rst en
    $ let (msgSig, flushSig) = unbundle inputSig
       ...
       in Sponge.NonPipelined.SampleNTT.sponge @System spongeFSM inputWithFlush
