...
import SHA3internal (sha3_constants, chi_constants, pi_constants)
...
-- Partial Keccak round: Pi followed by Chi
piChiF200BitVec :: BitVector 200 -> BitVector 200
piChiF200BitVec = chiF200BitVec . piF200BitVec

{-# ANN topEntity
  (Synthesize
    { t_name = "PiChi_F200BitVec_OneRound"
...
topEntity :: Clock System
          ...
          -> Signal System State200
topEntity = exposeClockResetEnable $ fmap piChiF200BitVec
