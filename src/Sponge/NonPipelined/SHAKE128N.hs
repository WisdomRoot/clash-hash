...
type SpongeState = N.State PadBeats (Index RateBeats)
...
step _permModule (State (Absorb counter) state) (input, _tready, flush) = absorb pad XOR.staticXOR128' counter state input flush
